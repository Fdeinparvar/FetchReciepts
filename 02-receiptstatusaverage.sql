...
SELECT A.rewards_receipt_status AS Receipt_Status, A.Average_Spent AS Average_Spent, CASE A.r WHEN 1 THEN CONCAT(A.rewards_receipt_status , ' reciepts have the higher average spent per receipt') ELSE '' END AS Result FROM       
